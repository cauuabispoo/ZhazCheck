...
function gerarChecklist() {
    ...
    switch (tipoEquipamento) {
        case 'coletor':
            ...
            break;
        case 'leitor':
            itens = ['CARCAÇA', 'LENTE', 'GATILHO', 'MODELO/NÚMERO DE SÉRIE', 'ALTO-FALANTE', 'MÓDULO LASER', 'CABO DE COMUNICAÇÃO', 'FONTE DE ALIMENTAÇÃO', 'CONFIGURAÇÃO', 'BATERIA', 'BASE DE COMUNICAÇÃO BLUETOOTH', 'DISPLAY', 'WI-FI', 'MEMÓRIA FLASH'];
            break;
        case 'impressora':
