...
const dados = [
    {
        id: 1, nome: 'Substituição de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'GUIA DE ETIQUETA', 'TRAVAS', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR'], valor: '1'
    },

    {
        id: 10, nome: 'Instalação de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'TRAVAS', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR'], valor: '10'
    },
    ...
    { id: 3, nome: 'Recuperação de carcaça', equipamentos: ['CARCAÇAS', 'TRAVAS DA BATERIA/TAMPA', 'GATILHO', 'BASE DE COMUNICAÇÃO BLUETOOTH', 'TRAVAS', 'CORTADOR'], valor: '3' },
...

    {
        id: 15, nome: 'Observação', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS', 'observacoes', 'MODELO/NÚMERO DE SÉRIE',
            ...
            'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR'], valor: '15'
    },
];
