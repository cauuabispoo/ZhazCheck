...
const dados = [
    {
        id: 1, nome: 'Substituição de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'GUIA DE ETIQUETA', 'TRAVAS', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA', 'PAINEL', 'FONTE DE ALIMENTAÇÃO', 'CABO DE COMUNICAÇÃO'], valor: '1'
    },

    {
        id: 10, nome: 'Instalação de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'TRAVAS', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA', 'PAINEL'], valor: '10'
    },
...
const filtro = {
    'TOUCH': ['touch'],
    'PAINEL': ['PAINEL'],
    'ACESSÓRIOS': ['capa', 'hidrogel', 'pelicula ', 'capinha', 'manopla', 'gatilho', 'pistola', 'ALCA', 'PEEL OFF'],
    'CABO DE COMUNICAÇÃO': ['cabo'],
    'FONTE DE ALIMENTAÇÃO': ['FONTE', 'PLACA FONTE'],
    'PLACA PRINCIPAL': ['PLACA PRINCIPAL'],
    'CARCAÇAS': ['CARCACA', 'PE DE APOIO', 'EIXO INFERIOR DE ROTACAO', 'CAPA DO SCANNER DE ROTACAO', 'GABINETE', 'VEDACAO', 'TAMPA DO TEAR OFF', 'TAMPA SUPERIOR CINZA'],
    'LENTE': ['LENTE'],
    'PARAFUSOS': ['PARAFUSO'],
    'LCD': ['LCD'],
