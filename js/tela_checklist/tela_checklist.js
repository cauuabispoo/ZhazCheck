...
function gerarChecklist() {
    ...
    switch (tipoEquipamento) {
        case 'coletor':
            itens = ['CARCAÇAS', 'LENTE', 'PARAFUSOS', 'MODELO/NÚMERO DE SÉRIE', 'ACESSÓRIOS', 'TOUCH', 'LCD', 'WI-FI', 'MÓDULO LASER', 'ALTO-FALANTE', 'CÂMERA', 'TECLADO', 'GATILHO/BOTÕES LAT.', 'BATERIA', 'TRAVAS DA BATERIA/TAMPA', 'CARREGAMENTO/COMUNICAÇÃO - (SYNC/CHARGER)', 'SISTEMA OPERACIONAL', 'CONFIGURAÇÕES DO CLIENTE'];
            break;
        case 'leitor':
            itens = ['CARCAÇA', 'LENTE', 'GATILHO', 'MODELO/NÚMERO DE SÉRIE', 'ALTO-FALANTE', 'MÓDULO LASER', 'CABO DE COMUNICAÇÃO', 'FONTE DE ALIMENTAÇÃO', 'CONFIGURAÇÃO', 'BATERIA', 'BASE DE COMUNICAÇÃO BLUETOOTH', 'DISPLAY', 'WI-FI', 'MEMÓRIA FLASH', 'CARREGAMENTO/COMUNICAÇÃO'];
            break;
        case 'impressora':
            ...
            break;
        case 'celular':
            itens = ['CARCAÇAS', 'TAMPA DA BATERIA', 'MODELO/NÚMERO DE SÉRIE', 'ACESSÓRIOS', 'TOUCH', 'LCD', 'CÂMERA(S) TRASEIRA', 'CÂMERA FRONTAL', 'WI-FI/BLUETOOTH', 'ALTO-FALANTE AURICULAR', 'ALTO-FALANTE PRINCIPAL', 'MICROFONE', 'CONECTOR DE ENTRADA P2', 'BATERIA', 'CARREGAMENTO/COMUNICAÇÃO - (SYNC/CHARGER)', 'BOTÕES LATERAIS', 'CONEXÃO NAS REDES GSM(CARTÃO SIM)', 'COMPARTIMENTO DO CARTÃO SD', 'SENSOR BIOMÉTRICO', 'SISTEMA OPERACIONAL'];
            break;
        default:
