...
const dados = [
    {
        id: 1, nome: 'Substituição de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            'LCD', 'PLACA PRINCIPAL', 'PLACA POWERBOARD', 'WI-FI', 'MÓDULO LASER', 'ALTO-FALANTE', 'CÂMERA', 'CÂMERA(S) TRASEIRA', 'CÂMERA FRONTAL', 'TECLADO', 'GATILHO/BOTÕES LAT.', 'BATERIA',
            ...
            'CONEXÃO NAS REDES GSM(CARTÃO SIM)', 'COMPARTIMENTO DO CARTÃO SD', 'ALTO-FALANTE PRINCIPAL', 'ALTO-FALANTE AURICULAR'], valor: '1'
    },

    {
        id: 10, nome: 'Instalação de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'TRAVAS', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA', 'PAINEL', 'CONEXÃO NAS REDES GSM(CARTÃO SIM)', 'COMPARTIMENTO DO CARTÃO SD', 'ALTO-FALANTE PRINCIPAL', 'ALTO-FALANTE AURICULAR'], valor: '10'
    },

    {
        id: 2, nome: 'Recuperação de placa', equipamentos: ['PLACA PRINCIPAL', 'PLACA POWERBOARD', 'WI-FI', 'MÓDULO LASER', 'CÂMERA', 'CÂMERA(S) TRASEIRA', 'CÂMERA FRONTAL', 'TECLADO', 'GATILHO/BOTÕES LAT.',
            ...
            'CONEXÃO NAS REDES GSM(CARTÃO SIM)', 'COMPARTIMENTO DO CARTÃO SD', 'ALTO-FALANTE PRINCIPAL', 'ALTO-FALANTE AURICULAR'], valor: '2'
    },
...

    {
        id: 15, nome: 'Observação', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS', 'observacoes', 'MODELO/NÚMERO DE SÉRIE',
            ...
            'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA', 'PAINEL', 'CONEXÃO NAS REDES GSM(CARTÃO SIM)', 
            'COMPARTIMENTO DO CARTÃO SD', 'ALTO-FALANTE PRINCIPAL', 'ALTO-FALANTE AURICULAR'], valor: '15'
    },
...
const filtro = {
    ...
    'CARCAÇAS': ['CARCACA', 'PE DE APOIO', 'EIXO INFERIOR DE ROTACAO', 'CAPA DO SCANNER DE ROTACAO', 'GABINETE', 'VEDACAO', 'TAMPA DO TEAR OFF', 'TAMPA SUPERIOR CINZA', 'TAMPA DE PROTECAO', 'CONJUNTO SUPERIOR INTERNO'],
    'LENTE': ['LENTE'],
    'PARAFUSOS': ['PARAFUSO'],
    'LCD': ['LCD'],
    ...
    'WI-FI': ['WIFI', 'WI-FI', 'ANTENA'],
    'MÓDULO LASER': ['MODULO', 'DIODO', 'LASER'],
    'ALTO-FALANTE': ['ALTO-FALANTE', 'ALTOFALANTE', 'ALTO FALANTE', 'PLACA'],
    'ALTO-FALANTE PRINCIPAL': ['ALTO-FALANTE', 'ALTOFALANTE', 'ALTO FALANTE', 'PLACA'],
    'ALTO-FALANTE AURICULAR': ['ALTO-FALANTE', 'ALTOFALANTE', 'ALTO FALANTE', 'PLACA'],
    'CÂMERA': ['CAMERA'],
    'CÂMERA(S) TRASEIRA': ['CAMERA'], 
    'CÂMERA FRONTAL': ['CAMERA'],
    'TECLADO': ['TECLADO'],
