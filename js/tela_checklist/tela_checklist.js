    ...
    switch (tipoEquipamento) {
        ...
        case 'impressora':
            itens = ['CARCAÇAS', 'PLACA PRINCIPAL', 'MODELO/NÚMERO DE SÉRIE', 'PARAFUSOS', 'ACESSÓRIOS', 'CABO DE COMUNICAÇÃO', 'FONTE DE ALIMENTAÇÃO',
                ...
                'ALIMENTADOR', 'TRACIONADOR', 'BOTÕES', 'GUIA DE ETIQUETA', 'TRAVAS', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'WI-FI', 'BATERIA', 'CONFIGURAÇÃO', 'SISTEMA OPERACIONAL'];
            break;
        case 'celular':
...
const dados = [
    {
        id: 1, nome: 'Substituição de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'GUIA DE ETIQUETA', 'TRAVAS', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO'], valor: '1'
    },

    {
        id: 10, nome: 'Instalação de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'TRAVAS', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO'], valor: '10'
    },

    {
        id: 2, nome: 'Recuperação de placa', equipamentos: ['PLACA PRINCIPAL', 'PLACA POWERBOARD', 'WI-FI', 'MÓDULO LASER', 'CÂMERA', 'TECLADO', 'GATILHO/BOTÕES LAT.',
            ...
            'SENSOR DO RIBBON', 'ALIMENTADOR', 'TRACIONADOR', 'BOTÕES', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO'], valor: '2'
    },

    { id: 3, nome: 'Recuperação de carcaça', equipamentos: ['CARCAÇAS', 'TRAVAS DA BATERIA/TAMPA', 'GATILHO', 'BASE DE COMUNICAÇÃO BLUETOOTH', 'TRAVAS'], valor: '3' },
...

    {
        id: 15, nome: 'Observação', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS', 'observacoes', 'MODELO/NÚMERO DE SÉRIE',
            ...
            'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO'], valor: '15'
    },
];
