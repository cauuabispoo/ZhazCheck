    ...
    switch (tipoEquipamento) {
        ...
        case 'impressora':
            itens = ['CARCAÇAS', 'PLACA PRINCIPAL', 'MODELO/NÚMERO DE SÉRIE', 'PARAFUSOS', 'CABO DE COMUNICAÇÃO', 'FONTE DE ALIMENTAÇÃO', 
                ...
                'ALIMENTADOR', 'TRACIONADOR', 'BOTÕES', 'GUIA DE ETIQUETA', 'TRAVAS', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'WI-FI', 'BATERIA'];
            break;
        case 'celular':
...
const filtro = {
    'TOUCH': ['touch'],
    'ACESSÓRIOS': ['capa ', 'hidrogel', 'pelicula ', 'capinha', 'manopla', 'gatilho', 'pistola', 'SUPORTE', 'ADAPTADOR'],
    ...
    'CÂMERA': ['CAMERA'], 
    'TECLADO': ['TECLADO'], 
    'GATILHO/BOTÕES LAT.': ['GATILHO', 'BOTOES'], 
    'BATERIA': ['BATERIA'],
