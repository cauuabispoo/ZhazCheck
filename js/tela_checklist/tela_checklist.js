...
const dados = [
    {
        id: 1, nome: 'Substituição de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'GUIA DE ETIQUETA', 'TRAVAS', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA'], valor: '1'
    },

    {
        id: 10, nome: 'Instalação de componente', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS',
            ...
            'TRAVAS', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA'], valor: '10'
    },

    {
        id: 2, nome: 'Recuperação de placa', equipamentos: ['PLACA PRINCIPAL', 'PLACA POWERBOARD', 'WI-FI', 'MÓDULO LASER', 'CÂMERA', 'TECLADO', 'GATILHO/BOTÕES LAT.',
            ...
            'SENSOR DO RIBBON', 'ALIMENTADOR', 'TRACIONADOR', 'BOTÕES', 'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR'], valor: '2'
    },

    { id: 3, nome: 'Recuperação de carcaça', equipamentos: ['CARCAÇAS', 'TRAVAS DA BATERIA/TAMPA', 'GATILHO', 'BASE DE COMUNICAÇÃO BLUETOOTH', 'TRAVAS', 'CORTADOR', 'TAMPA DA BATERIA'], valor: '3' },
...

    {
        id: 15, nome: 'Observação', equipamentos: ['TOUCH', 'CARCAÇAS', 'LENTE', 'PARAFUSOS', 'observacoes', 'MODELO/NÚMERO DE SÉRIE',
            ...
            'SERIAL', 'PARALELA', 'ETHERNET', 'USB', 'BLUETOOTH', 'PLACA SECUNDÁRIA', 'SENSOR BIOMÉTRICO', 'CORTADOR', 'TAMPA DA BATERIA'], valor: '15'
    },
];
...
const filtro = {
    ...
    'CARCAÇAS': ['CARCACA', 'PE DE APOIO', 'EIXO INFERIOR DE ROTACAO', 'CAPA DO SCANNER DE ROTACAO', 'PAINEL'],
    'LENTE': ['LENTE'],
    'PARAFUSOS': ['PARAFUSO'],
    'LCD': ['LCD'],
